...
import com.daneshnaik.chatbot.Activities.chatActivity;
...
FirebaseDatabase.getInstance().getReference().child("chats").child(senderRoom).addValueEventListener(new ValueEventListener() {
    ...
    holder.Name_taker.setText(user.getName());
    holder.Email_taker.setText(user.getEmail());
        Glide.with(context).load(user.getProfileImage()).placeholder(R.drawable.baseline_person_24).into(holder.photo_taker);
...
//        });
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("profile_image",user.getProfileImage());
